...
sys.path.append('/Users/ismailbenaija/PycharmProjects/SMA/Projet2/mesa')
...
class Preferences:
    ...
    def most_preferred(self, item_list):
        ...
        for item_1 in item_list:
            if self.is_preferred_item(item_1,best):
                best=item_1
        return best
    ...
    def is_item_among_top_10_percent(self, item,items):
        ...
        for i in range(1, math.ceil(len(item_and_score_list)/10+1)):
            best_items.append(item_and_score_list[-i][0])
        return item in best_items
